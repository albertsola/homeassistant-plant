...
class PlantCareSummary(PlantCareEntity, SensorEntity):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            "switch_entity": options.get(CONF_SWITCH),
            "schedule_enabled": data.schedule_enabled,
            "schedule_on": data.on_time.isoformat() if data.on_time else None,
            "schedule_off": data.off_time.isoformat() if data.off_time else None,
